            ...
            <YStack gap={"$2"}>
              {currentGPSData?.latitude && currentGPSData.longitude ? (
                <>
                  <XStack gap={"$2"} alignItems="center">
                    ...
                    <Text color={colors.text} fontWeight="600">
                      ...
                      {currentGPSData.accuracy !== null && (
                        <Text color={colors.gray[200]} fontSize={"$2"}> (Accuracy: {currentGPSData.accuracy.toFixed(0)}m)</Text>
                      )}
                    </Text>
                  </XStack>
                  ...
                  {currentGPSData.speed !== null && (
                    <Text color={colors.text} fontSize={"$3"}>
                      Speed: {(currentGPSData.speed * 3.6).toFixed(1)} km/h
                    </Text>
                  )}
                </>
              ) : (
